...
namespace FirebaseWebGL.Scripts.FirebaseBridge
{
    public static class FirebaseAuth
    {
        ...
        public static extern void CreateUserWithEmailAndPassword(string email, string password, string displayName, string objectName, string callback,string fallback);
